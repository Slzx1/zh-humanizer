...
version: 1.1.0
description: |
  移除中文文本中的 AI 生成痕迹，降低 gptzero 等检测器的 AI 识别率。
...
AI 生成文本在统计上最显著的特征是**中频词缺失 60-70%**——导致文本读起来"平滑但空洞"。真人写作充满具体名词、数字、时间、地点、人名。
